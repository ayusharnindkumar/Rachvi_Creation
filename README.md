...
Framer Motion, Swiper, Lucide React, Radix UI
...
Add starter products to MongoDB
...
Registration, login, profile, addresses, and wishlist

/api/products

Product catalogue, product management, and reviews

/api/orders

Checkout, Razorpay verification, order history, and tracking

/api/admin

Store statistics, customers, and role management
...
Set FRONTEND_URL on the backend to the public frontend URL.

Add every backend environment variable through the hosting dashboard.

Never expose JWT_SECRET, CLOUDINARY_API_SECRET, or RAZORPAY_KEY_SECRET in frontend variables.
